<div class="row--latest-arrival row bg-dark">
    <h2 class="has-text-align-center"><span class="has-inline-color has-white-color">Latest Arrival</span></h2>
    <div class="products--list">
        <div class="card-group">
            <?php
                $args = array( 'post_type' => 'product', 'per_page' => 4);
    ...
    <div class="row mt-4 mb-4 justify-content-center">
        <div class="col-md-12 mr-4 text-center">
            <a class="btn btn-lg btn-outline-light" href="/shop">View More</a>
        </div>
    </div>
</div>