...
<div class="wf_sub_tab_container">
	<div class="wf_sub_tab_content" data-id="add-new-ftp" style="display:block;" id="wp_mgdp_form_wrapper">
		<h3 class="wt_mgdp_form_title"> <?php _e("Add new FTP profile", 'wp-migration-duplicator'); ?></h3>
		...
		<form method="post" action="<?php echo esc_url($_SERVER["REQUEST_URI"]); ?>" id="wt_mgdp_ftp_form">
			...
			<table class="form-table wf-form-table">
				...
				<tr>
					...
					<td>
						<input type="password" name="wt_mgdp_ftppassword">
					</td>
					<td></td>
				</tr>
				<tr>
	...
	<div class="wf_sub_tab_content" data-id="ftp-profiles">
		...
		?>
		<h3><?php _e("FTP settings", 'wp-migration-duplicator'); ?></h3>
		<p><?php _e('Create and maintain multiple FTP profiles that can be used for the import/export operations of your site backups.','wp-migration-duplicator');?></p>
