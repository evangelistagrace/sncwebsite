...
<div style = "display: flex">
	<img src="<?php echo plugins_url(basename(plugin_dir_path(WT_MGDP_PLUGIN_FILENAME))).'/admin/images/s3.svg'; ?>" style="max-width:30px;"/>&nbsp&nbsp<h3><?php echo __('Amazon S3', 'wp-migration-duplicator'); ?></h3> &nbsp&nbsp&nbsp&nbsp <?php if( $authenticated === true ):?> <h4 style="color: green;"><?php _e('Connected','wp-migration-duplicator');?> </h4> <?php endif; ?>
</div>
		...
		<table class="form-table wf-form-table" style="max-width:800px;">
			<tbody>
				...
				<tr class="">
					...
					<td class="">
						<input type="password" class="" name="wt_s3bucket_secret_key" value="<?php echo $secretkey; ?>" id="wt_s3bucket_secret_key" style="width:100% ; border: 1px solid #ced4da;">
					</td>
				</tr>
				<tr class="">
