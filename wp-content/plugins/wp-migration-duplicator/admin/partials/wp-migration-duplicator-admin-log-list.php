...
<div class="wt_mgdp_history_page">
	...
	if(is_array($log_files) && count($log_files)>0)
	{
		...
		foreach($log_files as $log_file)
		{
			...
			?>
			<tr>
				<td class="log_file_name_col"><a class="wt_mgdp_view_log_btn" data-log-file="<?php echo $file_name;?>"><?php echo $file_name; ?></a></td>
				<td>
					<a class="wt_mgdp_delete_log" href="<?php echo str_replace('_log_file_', $file_name, $delete_url);?>"><?php _e('Delete'); ?></a>
					| <a class="wt_mgdp_view_log_btn" data-log-file="<?php echo $file_name;?>"><?php _e("View");?></a>
					| <a class="wt_mgdp_download_log_btn" href="<?php echo str_replace('_log_file_', $file_name, $download_url);?>"><?php _e("Download");?></a>
				</td>
			</tr>
			<?php
		}
