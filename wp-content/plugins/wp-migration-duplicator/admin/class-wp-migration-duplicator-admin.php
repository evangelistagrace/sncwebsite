...
class Wp_Migration_Duplicator_Admin
{
	...
	public function __construct($plugin_name, $version)
	{
		...
		add_action('admin_init', array($this, 'log_download_file'), 11);
                ...
                add_action('post-upload-ui', array( $this,'post_upload_ui_add_link'));
	}
	...
	*/
	public function admin_menu()
	{
		/*$menus = array(
			...
			array(
				'menu',
				__('Migration & Backup', 'wp-migration-duplicator'),
				__('WordPress Migration', 'wp-migration-duplicator'),
                                'manage_options',
                                $this->plugin_name,
                            	array($this,'admin_settings_page'),
...
<?php
	...
	public function wt_migrator_populate_cloud_files() {
       ...
       public function post_upload_ui_add_link() {
            ?><a href="https://www.webtoffee.com/increase-maximum-upload-file-size-in-wordpress-migrator/" target="_blank"><?php _e( 'How-to: Increase maximum upload file size', 'wp-migration-duplicator' ); ?></a><br/><br/><?php
        }
